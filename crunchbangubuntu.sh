...
case "$answer" in
        Yes|yes|Y|y|"") echo "Ok..."
            sudo apt-get install -y xorg lightdm gedit gksu network-manager network-manager-gnome thunar xfce4-terminal openbox obconf obmenu tint2 xcompmgr nitrogen hsetroot;;
